...
const imageObj = {
  bug: '/docs/assets/images/bugIcon.png',
  dark: ('/docs/assets/images/darkIcon.png'),
  dragon: ('/docs/assets/images/dragonIcon.png'),
  electric: ('/docs/assets/images/electricIcon.png'),
  fairy: ('/docs/assets/images/fairyIcon.png'),
  fighting: ('/docs/assets/images/fightingIcon.png'),
  fire: ('/docs/assets/images/fireIcon.png'),
  flying: ('/docs/assets/images/flyingIcon.png'),
  ghost: ('/docs/assets/images/ghostIcon.png'),
  grass: ('/docs/assets/images/grassIcon.png'),
  ground: ('/docs/assets/images/groundIcon.png'),
  ice: ('/docs/assets/images/iceIcon.png'),
  normal: ('/docs/assets/images/normalIcon.png'),
  poison: ('/docs/assets/images/poisonIcon.png'),
  psychic: ('/docs/assets/images/psychicIcon.png'),
  rock: ('/docs/assets/images/rockIcon.png'),
  steel: ('/docs/assets/images/steelIcon.png'),
  water: ('/docs/assets/images/waterIcon.png'),
};
